...
<div  ng-controller="employeesController">
    ...
    <table class="table table-inverse">
        ...
        <tr>
            ...
            <th>Contact No</th>
            <th>Position</th>
            <th><button id="btn-add" class="btn btn-success btn-sm" ng-click="toggle('add', 0)">Add New Employee</button></th>
        </tr>
        </thead>
        <tbody>
        <tr ng-repeat="employee in employees">
            ...
            <td>
                <button class="btn btn-primary btn-xs" ng-click="toggle('edit', employee.id)">Edit</button>
                <button class="btn btn-danger btn-xs" ng-click="confirmDelete(employee.id)">Delete</button>
            </td>
        </tr>
        </tbody>
    </table>
